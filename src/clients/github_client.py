...
class GitHubClient:
    ...
    def get_pr_context(self, installation_id: int, repo_full_name: str, 
    ...
    def create_comment(self, installation_id: int, repo_full_name: str,
    ...
    def create_check_run(self, installation_id: int, repo_full_name: str,
                        head_sha: str, name: str = "AI Code Review",
                        status: str = "in_progress", conclusion: Optional[str] = None,
                        title: Optional[str] = None, summary: Optional[str] = None) -> bool:
        """
