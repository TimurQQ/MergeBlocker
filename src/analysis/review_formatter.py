...
class ReviewFormatter:
    ...
    @staticmethod
    def format_review_comment(review_result: Dict[str, Any], 
                              pr_info: Dict[str, Any],
                              quick_warnings: List[str] = None) -> str:
        """
...
<sub>🤖 This review was generated by MergeBlocker AI. It's meant to assist human reviewers, not replace them. Please use your judgment when addressing these suggestions.</sub>
"""
...
"""
    ...
    @staticmethod
    def format_check_run_summary(review_result: Dict[str, Any],
                                 pr_info: Dict[str, Any],
                                 quick_warnings: List[str] = None) -> Dict[str, str]:
        """
