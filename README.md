...
- 💬 **Интерактивный диалог** - отвечайте на комментарии бота и задавайте вопросы
...
- ✅ **Pull request review comment** (для ответов на комментарии бота)

> 📖 **Подробнее о настройке reply функциональности**: [docs/SETUP_REPLY_FUNCTIONALITY.md](docs/SETUP_REPLY_FUNCTIONALITY.md)
...
### Интерактивный диалог (Reply)

После того как бот оставил комментарий к коду:

1. Найдите inline комментарий бота в **Files Changed**
2. Нажмите **Reply** под комментарием
3. Задайте вопрос (например: "Почему это плохо?", "Как правильно исправить?")
4. Бот автоматически ответит с учетом контекста кода и PR
...
> 📖 **Требует настройки:** [docs/SETUP_REPLY_FUNCTIONALITY.md](docs/SETUP_REPLY_FUNCTIONALITY.md)
